...
class _DirectoAiReportDialogState extends State<DirectoAiReportDialog> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _successMessage = 'Sua denúncia foi enviada com sucesso.';
      });
            ...
            children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10),
                      borderSide: const BorderSide(color: Color(0xFF0D63D6)),
                    ),
                  ),
                ),
                Align(
              ...
              if (_errorMessage.isNotEmpty || _successMessage.isNotEmpty)
                Padding(
                  ...
                  child: Text(
                    _errorMessage.isNotEmpty ? _errorMessage : _successMessage,
                    style: TextStyle(
                      fontSize: 11,
