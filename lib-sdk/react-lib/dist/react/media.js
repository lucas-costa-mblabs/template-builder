...
export function inferMediaType(url, explicitType) {
    const normalizedExplicit = typeof explicitType === "string" ? explicitType.trim().toLowerCase() : "";
    if (normalizedExplicit === "video")
        return "video";
