...
export declare function TemplateProvider({ theme: themeProp, templates, config: providedConfig, tracker: providedTracker, onReportSubmit, children, }: TemplateProviderProps): import("react/jsx-runtime").JSX.Element;
